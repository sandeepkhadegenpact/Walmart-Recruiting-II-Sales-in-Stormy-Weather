...
trainWeatherData = []
trainData = pd.read_sql_query('SELECT * FROM train where units>0 limit 10000', csv_database)
...
x = pd.read_csv(path+'train1.csv', usecols=['tmax', 'tmin','tavg','wetbulb','heat','cool','sealevel','station_number','store_nbr','item_nbr','stnpressure','resultspeed','sunrise', 'sunset','depart', 'dewpoint', 'wetbulb','snowfall', 'preciptotal'])
y = pd.read_csv(path+'train1.csv', usecols=['units'])
